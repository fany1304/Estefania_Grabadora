package com.estefania.videoplayer;
...
public class MainActivity extends Activity implements
    ...
    public void onPrepared(MediaPlayer mp) {
        ...
        int mVideoHeigth = mediaPlayer.getVideoHeight();

        if(mVideoWidth != 0 && mVideoHeigth != 0){

            surfaceHolder.setFixedSize(mVideoWidth, mVideoHeigth);
            mediaPlayer.start();
        }
